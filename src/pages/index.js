    ...
    <div className="wrapper">
      ...
      <main>
        <section className="home-about-container">
          ...
          <p className="content">
            Analyzes designs with product mindset and converts them into
            attractive, interactive websites. Collaborates with designers,
            backend developers, and managers to achieve the shared vision
            together.
          </p>
          <p className="content">
            Worked on variety of websites and SaaS web apps considering key
            elements of web development SEO, Performance, and Maintainability.
            Enjoys learning new technologies, and blogging about them on Medium
            or here.
          </p>
          <p className="content">
            Core skills are{" "}
            <strong className="highlight">HTML CSS & JAVASCRIPT.</strong>
          </p>
          <p className="content">
            Currently focusing on learning{" "}
            <strong className="highlight">
              web animations, SVG's and accessibility
            </strong>
            .
          </p>
        </section>
